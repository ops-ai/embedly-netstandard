...
namespace Embedly.Http
{
    ...
    /// The ResponseStream property will be not null in the case of a successful request/response cycle. Use this stream to
    ...
    internal class HttpWebRequestCallbackState
    {
        ...
        public HttpWebRequestCallbackState(HttpWebResponse response, object state)
        {
            ...
            string contentEncoding = response.Headers[HttpResponseHeader.ContentEncoding] ?? string.Empty;
