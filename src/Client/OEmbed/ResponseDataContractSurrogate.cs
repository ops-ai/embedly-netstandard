...
namespace Embedly.OEmbed
{
    ...
    /// </summary>
    public class ResponseDataContractSurrogate
    {
        ...
        {
            if (typeof(Response).GetTypeInfo().IsAssignableFrom(type))
            {
        ...
        public object GetDeserializedObject(object obj, Type targetType)
        {
            ...
            if (response != null)
            {
                ...
                {
                    case "error":
                        typeClass = typeof (EmbedError);
                        break;
                    case "link":
                        typeClass = typeof (EmbedLink);
                        break;
                    case "photo":
                        typeClass = typeof (EmbedPhoto);
                        break;
                    case "rich":
                        typeClass = typeof (EmbedRich);
                        break;
                    case "video":
                        typeClass = typeof (EmbedVideo);
                        break;
